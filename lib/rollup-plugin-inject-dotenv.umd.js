(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('node:fs'), require('node:path'), require('fs'), require('path'), require('os'), require('crypto')) :
  typeof define === 'function' && define.amd ? define(['node:fs', 'node:path', 'fs', 'path', 'os', 'crypto'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.injectEnv = factory(global.node_fs, global.nodePath, global.require$$0, global.require$$1, global.require$$2, global.require$$3));
})(this, (function (node_fs, nodePath, require$$0, require$$1, require$$2, require$$3) { 'use strict';
