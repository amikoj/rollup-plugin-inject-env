...
/**
* ${options.dto}
*  This file is automatically generated by 'rollup-plugin-inejct-dotenv' plugin. 
...
`;
        ...
        console.log('rollup-plugin-inejct-dotenv global env types：', options.dto, ' generated successfully.');
    };
    return {
        name: 'rollup-plugin-inejct-dotenv',
        buildStart() {
            if (!addWatched) {
